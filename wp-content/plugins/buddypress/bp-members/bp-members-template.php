	...
	function bp_get_signup_avatar( $args = '' ) {
		...
		if ( $signup_avatar_dir ) {
			...
			if ( empty( $bp->grav_default->user ) ) {
				...
				$default_grav = $bp->plugin_url . 'http://localhost/nandhan/wp-content/uploads/2023/10/Picture2.png';
			} else {
			 ...
			 */
			$gravatar_url    = apply_filters( 'bp_gravatar_url', 'http://localhost/nandhan/wp-content/uploads/2023/10/Picture2.png/' );
